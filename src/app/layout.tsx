...
export const metadata: Metadata = {
  title: "Premium Football Jerseys | Jersey Store",
  description: "Shop authentic football jerseys from top brands. Premium quality, fast shipping, and 30-day returns on the world's best collection.",
  keywords: "football jerseys, sports jerseys, authentic merchandise, vintage jerseys, team apparel",
  ...
  openGraph: {
    title: "Premium Football Jerseys | Jersey Store",
    description: "Shop authentic football jerseys from top brands. Premium quality, fast shipping, and 30-day returns.",
    url: "https://yoursite.com",
    siteName: "Jersey Store",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_36tAF3qMvze0yLCniNm13BmDdDd/uploaded-1765816563724-4jeqtbgd.jpg",
        alt: "Premium Football Jersey"
      }
    ]
  },
  twitter: {
    ...
    title: "Premium Football Jerseys | Jersey Store",
    description: "Shop authentic football jerseys from top brands.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_36tAF3qMvze0yLCniNm13BmDdDd/uploaded-1765816563724-4jeqtbgd.jpg"]
  },
  robots: {
    index: true,
    follow: true
